    ...
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        ...
        <TouchableOpacity style={styles.calculateButton} onPress={() => {
            ...
            newUserInput[0] = parseFloat(systolic);
            newUserInput[1] = parseFloat(diastolic);
            newUserInput[2] = parseFloat(cholesterol);
            newUserInput[3] = parseFloat(bloodSugar);
            newUserInput[4] = parseFloat(bmi);
            newUserInput[5] = parseFloat(exercise);
            newUserInput[6] = hasDiabetes ? 1 : 0;
            newUserInput[7] = hadStroke ? 1 : 0;
            // Fill the rest of the array as needed
